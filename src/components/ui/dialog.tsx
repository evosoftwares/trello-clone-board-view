...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-shrink-0 flex-col space-y-1.5 p-6 pb-4 text-center sm:text-left",
      className,
    )}
    {...props}
  />
...
const DialogBody = (props: React.HTMLAttributes<HTMLDivElement>) => (
  <div className="flex-1 overflow-y-auto px-6" {...props} />
)
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-shrink-0 flex-col-reverse p-6 pt-4 sm:flex-row sm:justify-end sm:space-x-2",
      className,
    )}
    {...props}
  />
